...
TypeId
BitTorrentVideoClient::GetTypeId(void)
{
    static TypeId tid = TypeId("ns3::BitTorrentVideoClient").SetParent<BitTorrentClient>().AddConstructor<BitTorrentVideoClient>();
    return tid;
}

void
BitTorrentVideoClient::StopApplication()
{
    BitTorrentClient::StopApplication();
}

void
BitTorrentVideoClient::StartApplication()
{
...
Time
BitTorrentVideoClient::GetTotalLength() const
{
    return m_totalLength;
}

Time
BitTorrentVideoClient::GetPlaybackPosition() const
{
    return m_playbackPosition;
}

Time
BitTorrentVideoClient::GetPreBufferingTime() const
{
    return m_preBufferingTime;
}

void
BitTorrentVideoClient::SetPreBufferingTime(Time preBufferingTime)
{
...
bool
BitTorrentVideoClient::GetAutoPlay() const
{
    return m_autoPlay;
}

void
BitTorrentVideoClient::SetAutoPlay(bool autoPlay)
{
    m_autoPlay = autoPlay;
}

bool
BitTorrentVideoClient::GetAutoPlayFromRight() const
{
    return m_autoPlayFromRight;
}

void
BitTorrentVideoClient::SetAutoPlayFromRight(bool autoPlayFromRight)
{
    m_autoPlayFromRight = autoPlayFromRight;
}

bool
BitTorrentVideoClient::GetPiecesMissable() const
{
    return m_piecesMissable;
}

void
BitTorrentVideoClient::SetPiecesMissable(bool piecesMissable)
{
    m_piecesMissable = piecesMissable;
}

Time
BitTorrentVideoClient::GetSkipTolerance() const
{
    return m_skipTolerance;
}

void
BitTorrentVideoClient::SetSkipTolerance(Time skipTolerance)
{
...
Time
BitTorrentVideoClient::GetRequiredContinousPlaybackAfterSkip() const
{
    return m_continousPlaybackAfterSkip;
}

void
BitTorrentVideoClient::SetRequiredContinousPlaybackAfterSkip(Time continousPlaybackAfterSkip)
{
...
uint32_t
BitTorrentVideoClient::GetCurrentPiece() const
{
    return TimeToPiece(m_playbackPosition);
}

bool
BitTorrentVideoClient::IsPlaying() const
{
    return m_playing;
}

bool
BitTorrentVideoClient::IsPaused() const
{
    return m_paused;
}

Time
BitTorrentVideoClient::GetRemainingPause() const
{
...
uint32_t
BitTorrentVideoClient::GetContinousPiecesFromPiece(uint32_t piece) const
{
    uint32_t result = 0;
...
uint32_t
BitTorrentVideoClient::GetContinousMissingPiecesFromPiece(uint32_t piece) const
{
...
Time
BitTorrentVideoClient::GetTimeUntilPiece(uint32_t piece) const
{
...
void
BitTorrentVideoClient::SetPlaybackPosition(Time position)
{
...
void
BitTorrentVideoClient::SetPlaybackPositionRelative(Time change)
{
...
void
BitTorrentVideoClient::SetPlaybackPositionToTheRight(bool keepPreBufferingPhase)
{
...
void
BitTorrentVideoClient::BufferFor(Time bufferingPeriod)
{
    if (!m_playing)
    {
...
void
BitTorrentVideoClient::BufferNext(Time period)
{
    BufferUntil(m_playbackPosition + period);
}

void
BitTorrentVideoClient::BufferUntil(Time position)
{
    if (position > m_totalLength)
    {
...
void
BitTorrentVideoClient::BufferRange(uint32_t rangeStart, uint32_t rangeEnd)
{
    ...
    if (GetContinousPiecesFromPiece(rangeStart) < rangeEnd - rangeStart)
    {
        ...
        // Step 1c: Schedule the regular check for the appearance of the needed pieces
        m_nextBufferCheckEvent =
            Simulator::Schedule(MilliSeconds(m_milliSecondsPerPiece), &BitTorrentVideoClient::BufferRange, this, rangeStart, rangeEnd);
        m_pausedUntil = Simulator::Now() + m_totalLength;
    }
    else
    {
...
Time
BitTorrentVideoClient::PieceToTime(uint32_t piece) const
{
    return MilliSeconds(static_cast<uint64_t>(ceil(piece * m_milliSecondsPerPiece)));
}

uint32_t
BitTorrentVideoClient::TimeToPiece(Time time) const
{
    return floor(time.GetMilliSeconds() / m_milliSecondsPerPiece);
}

void
BitTorrentVideoClient::PlaybackStateChangedEvent()
{
...
void
BitTorrentVideoClient::PlaybackPositionChangedEvent()
{
...
void
BitTorrentVideoClient::PlaybackPositionWillChangePeriodicallyEvent()
{
...
void
BitTorrentVideoClient::CannotAdvancePlaybackEvent()
{
...
void
BitTorrentVideoClient::SkippedPiecesInPlaybackEvent(uint32_t oldPiece, uint32_t newPiece)
{
...
void
BitTorrentVideoClient::PlaybackFinishedEvent()
{
...
void
BitTorrentVideoClient::RegisterCallbackPlaybackStateChangedEvent(Callback<void> eventCallback)
{
    m_playbackStateChangedEventListeners.push_back(eventCallback);
}

void
BitTorrentVideoClient::UnregisterCallbackPlaybackStateChangedEvent(Callback<void> eventCallback)
{
    std::list<Callback<void>>::iterator iter = m_playbackStateChangedEventListeners.begin();
    for (; iter != m_playbackStateChangedEventListeners.end(); ++iter)
    {
...
void
BitTorrentVideoClient::RegisterCallbackPlaybackPositionChangedEvent(Callback<void, Time> eventCallback)
{
    m_playbackPositionChangedEventListeners.push_back(eventCallback);
}

void
BitTorrentVideoClient::UnregisterCallbackPlaybackPositionChangedEvent(Callback<void, Time> eventCallback)
{
    std::list<Callback<void, Time>>::iterator iter = m_playbackPositionChangedEventListeners.begin();
    for (; iter != m_playbackPositionChangedEventListeners.end(); ++iter)
    {
...
void
BitTorrentVideoClient::RegisterCallbackPlaybackPositionWillChangePeriodicallyEvent(Callback<void> eventCallback)
{
    m_playbackStateWillChangePeriodicallyEventListeners.push_back(eventCallback);
}

void
BitTorrentVideoClient::UnregisterCallbackPlaybackPositionWillChangePeriodicallyEvent(Callback<void> eventCallback)
{
    std::list<Callback<void>>::iterator iter = m_playbackStateWillChangePeriodicallyEventListeners.begin();
    for (; iter != m_playbackStateWillChangePeriodicallyEventListeners.end(); ++iter)
    {
...
void
BitTorrentVideoClient::RegisterCallbackCannotAdvancePlaybackEvent(Callback<void> eventCallback)
{
    m_CannotAdvancePlaybackEventListeners.push_back(eventCallback);
}

void
BitTorrentVideoClient::UnregisterCallbackCannotAdvancePlaybackEvent(Callback<void> eventCallback)
{
    std::list<Callback<void>>::iterator iter = m_CannotAdvancePlaybackEventListeners.begin();
    for (; iter != m_CannotAdvancePlaybackEventListeners.end(); ++iter)
    {
...
void
BitTorrentVideoClient::RegisterCallbackSkippedPiecesInPlaybackEvent(Callback<void, uint32_t, uint32_t> eventCallback)
{
    m_skippedPiecesInPlaybackEventListeners.push_back(eventCallback);
}

void
BitTorrentVideoClient::UnregisterCallbackSkippedPiecesInPlaybackEvent(Callback<void, uint32_t, uint32_t> eventCallback)
{
    std::list<Callback<void, uint32_t, uint32_t>>::iterator iter = m_skippedPiecesInPlaybackEventListeners.begin();
    for (; iter != m_skippedPiecesInPlaybackEventListeners.end(); ++iter)
    {
...
void
BitTorrentVideoClient::RegisterCallbackPlaybackFinishedEvent(Callback<void> eventCallback)
{
    m_playbackFinishedEventListeners.push_back(eventCallback);
}

void
BitTorrentVideoClient::UnregisterCallbackPlaybackFinishedEvent(Callback<void> eventCallback)
{
    std::list<Callback<void>>::iterator iter = m_playbackFinishedEventListeners.begin();
    for (; iter != m_playbackFinishedEventListeners.end(); ++iter)
    {
...
void
BitTorrentVideoClient::UnPauseAfterBuffering()
{
    if (m_playing)
    {
...
void
BitTorrentVideoClient::AdvancePlayback()
{
    ...
    if (m_playing && !m_paused)
    {
        ...
        if (neededPiece > currentPiece)
        {
            ...
            // Step 2b: Calculate the number of continously available pieces from the current position and compare this value to the number of needed
            // pieces
            ...
            if (m_piecesMissable)
            {
                ...
                if (PieceToTime(piecesToSkip) <= m_skipTolerance)
                {
                    ...
                    if (PieceToTime(piecesAfterwards) >= m_continousPlaybackAfterSkip)
                    {
                        ...
                        m_nextAdvancePlaybackEvent =
                            Simulator::Schedule(MilliSeconds(m_milliSecondsPerPiece), &BitTorrentVideoClient::AdvancePlayback, this);
                    }
                    // Step 3a3: We cannot skip because of the "afterward condition" and hence have to buffer until at least enough pieces are
                    // available after(!) the skip
                    else
                    {
                        NS_LOG_INFO(
                            "Cannot skip because continous playback after the skip would have been too short. Buffering until skip is possible.");
