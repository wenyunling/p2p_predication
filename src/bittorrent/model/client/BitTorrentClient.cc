...
BitTorrentClient::BitTorrentClient()
{
    ...
    m_autoConnect = true;
    m_seedingDuration =
        MilliSeconds(0) - MilliSeconds(1); // Should be negative; expressed like this to mute a certain version of the Intel C++ compiler
...
BitTorrentClient::StartApplication()
{
    ...
    case 'r': {
        ...
        std::set<uint32_t> indices =
            Utilities::GetRandomSampleF2((int)round(GetTorrent()->GetNumberOfPieces() * percentage), GetTorrent()->GetNumberOfPieces());
    ...
    default:
        bitfieldFiller = CreateObject<ConstantRandomVariable>();
        randomEndStart = bitfieldSize - static_cast<uint32_t>(
                                            ceil(bitfieldSize * lexical_cast<double>(m_bitfieldFillType.substr(1, m_bitfieldFillType.size() - 1))));
...
#endif
            + " (address " + outputIpString + ":" + lexical_cast<std::string>(GetPort()) + ")" + " using protocol " + m_protocol + " starting with " +
            lexical_cast<std::string>(m_piecesCompleted) + " pieces completed" + " and auto-connect " + (GetAutoConnect() ? "enabled" : "disabled"),
        true);
...
void
BitTorrentClient::SetInitialBitfield(std::string bitfieldFillType)
{
    m_bitfieldFillType = bitfieldFillType;
}

void
BitTorrentClient::ManipulateInitialBitfield(uint32_t bitfieldIndex, uint8_t value)
{
...
Time
BitTorrentClient::GetGatherMetricsEventPeriodicity() const
{
    return m_gatherMetricsEventPeriodicity;
}

void
BitTorrentClient::SetGatherMetricsEventPeriodicity(Time gatherMetricsEventPeriodicity)
{
...
const uint8_t*
BitTorrentClient::GetCurrentInfoHash() const
{
    return reinterpret_cast<const uint8_t*>(m_torrent->GetByteValueInfoHash());
}

std::string
BitTorrentClient::GetPeerId() const
{
    return m_peerId;
}

void
BitTorrentClient::SetInterfaceId(uint16_t interfaceId)
{
...
uint16_t
BitTorrentClient::GetInterfaceId() const
{
    return m_interfaceId;
}

Ptr<NetDevice>
BitTorrentClient::GetInterface() const
{
    return m_interface;
}

Ipv4Address
BitTorrentClient::GetIp() const
{
    return m_ip;
}

uint16_t
BitTorrentClient::GetPort() const
{
    return m_port;
}

void
BitTorrentClient::SetPort(uint16_t port)
{
    m_port = port;
}

DataRate
BitTorrentClient::GetBpsDownlink() const
{
...
DataRate
BitTorrentClient::GetBpsUplink() const
{
    DataRateValue result;
...
bool
BitTorrentClient::GetAutoConnect() const
{
    return m_autoConnect;
}

void
BitTorrentClient::SetAutoConnect(bool autoConnect)
{
...
Time
BitTorrentClient::GetSeedingDuration() const
{
    return m_seedingDuration;
}

void
BitTorrentClient::SetSeedingDuration(Time seedingDuration)
{
    m_seedingDuration = seedingDuration;
}

uint16_t
BitTorrentClient::GetDesiredPeers() const
{
    return m_desiredPeers;
}

void
BitTorrentClient::SetDesiredPeers(uint16_t desiredPeers)
{
...
void
BitTorrentClient::SetMaxPeers(uint16_t maxPeers)
{
...
uint16_t
BitTorrentClient::GetMaxUnchokedPeers() const
{
    return m_maxUnchokedPeers;
}

void
BitTorrentClient::SetMaxUnchokedPeers(uint16_t maxUnchokedPeers)
{
...
void
BitTorrentClient::SetMaxRequestsPerPeer(uint16_t maxRequestsPerPeer)
{
...
void
BitTorrentClient::SetMaxRequestsPerPiece(uint16_t maxRequestsPerPiece)
{
...
void
BitTorrentClient::SetMaxRequestsPerBlock(uint16_t maxRequestsPerBlock)
{
...
void
BitTorrentClient::SetMaxRequestsPerPeerPerPiece(uint16_t maxRequestsPerPeerPerPiece)
{
...
void
BitTorrentClient::SetRequestBlockSize(uint32_t requestBlockSize)
{
...
void
BitTorrentClient::SetSendBlockSize(uint32_t sendBlockSize)
{
    if (sendBlockSize > 0)
    {
...
void
BitTorrentClient::SetPieceTimeout(Time pieceTimeout)
{
...
void
BitTorrentClient::SetCheckDownloadedData(bool checkDownloadedData)
{
...
void
BitTorrentClient::SetPieceComplete(uint32_t pieceIndex)
{
...
const std::list<Ptr<AbstractStrategy>>&
BitTorrentClient::GetStrategies() const
{
    return m_strategyList;
}

std::list<Ptr<AbstractStrategy>>::const_iterator
BitTorrentClient::GetStrategyListIterator() const
{
    return m_strategyList.begin();
}

std::list<Ptr<AbstractStrategy>>::const_iterator
BitTorrentClient::GetStrategyListEnd() const
{
    return m_strategyList.end();
}

const std::map<std::string, std::string>&
BitTorrentClient::GetStrategyOptions() const
{
    return m_strategyOptions;
}

const std::pair<std::string, std::string>
BitTorrentClient::GetStrategyOptionChangePair(std::string name) const
{
...
std::string
BitTorrentClient::GetLastChangedStrategyOptionName() const
{
    return m_lastChangedStrategyOptionName;
}

void
BitTorrentClient::SetStrategyOptions(std::map<std::string, std::string> strategyOptions)
{
...
void
BitTorrentClient::SetConnectedToCloud(bool connectedToCloud)
{
    m_connectedToCloud = connectedToCloud;
}

bool
BitTorrentClient::GetConnectionToCloudSuspended() const
{
    return m_connectionToCloudSuspended;
}

void
BitTorrentClient::SetConnectionToCloudSuspended(bool connectionToCloudSuspended)
{
    m_connectionToCloudSuspended = connectionToCloudSuspended;
}

void
BitTorrentClient::ApplicationInitializedEvent()
{
...
void
BitTorrentClient::TrackerResponseReceivedEvent()
{
...
void
BitTorrentClient::PeerConnectionEstablishedEvent(Ptr<Peer> peer)
{
...
void
BitTorrentClient::PeerConnectionFailEvent(Ptr<Peer> peer)
{
...
void
BitTorrentClient::PeerConnectionCloseEvent(Ptr<Peer> peer)
{
...
void
BitTorrentClient::CloudConnectionEstablishedEvent()
{
...
void
BitTorrentClient::CloudConnectionSuspendedEvent()
{
...
void
BitTorrentClient::PeerChokeChangingEvent(Ptr<Peer> peer)
{
...
void
BitTorrentClient::PeerInterestedChangingEvent(Ptr<Peer> peer)
{
...
void
BitTorrentClient::PeerHaveEvent(Ptr<Peer> peer, uint32_t pieceIndex)
{
...
void
BitTorrentClient::PeerBitfieldReceivedEvent(Ptr<Peer> peer)
{
...
void
BitTorrentClient::PeerRequestEvent(Ptr<Peer> peer, uint32_t pieceIndex, uint32_t blockOffset, uint32_t blockLength)
{
...
void
BitTorrentClient::PeerCancelEvent(Ptr<Peer> peer, uint32_t pieceIndex, uint32_t blockOffset, uint32_t blockLength)
{
...
void
BitTorrentClient::PeerPortMessageEvent(Ptr<Peer> peer, uint16_t port)
{
...
void
BitTorrentClient::PeerExtensionMessageEvent(Ptr<Peer> peer, uint8_t messageId, std::string message)
{
...
void
BitTorrentClient::PieceRequestedEvent(Ptr<Peer> peer, uint32_t pieceIndex)
{
...
void
BitTorrentClient::PeerBlockCompleteEvent(Ptr<Peer> peer, uint32_t pieceIndex, uint32_t blockOffset, uint32_t blockLength)
{
...
void
BitTorrentClient::PieceCancelledEvent(Ptr<Peer> peer, uint32_t pieceIndex)
{
...
void
BitTorrentClient::PieceTimeoutEvent(Ptr<Peer> peer, uint32_t pieceIndex)
{
...
void
BitTorrentClient::PieceCompleteEvent(Ptr<Peer> peer, uint32_t pieceIndex)
{
...
void
BitTorrentClient::DownloadCompleteEvent()
{
    m_downloadCompleted = true;
...
void
BitTorrentClient::PeerBlockUploadCompleteEvent(Ptr<Peer> peer, uint32_t pieceIndex, uint32_t blockOffset, uint32_t blockLength)
{
...
// Used internally
void
BitTorrentClient::StrategyOptionsChangedEvent(std::string optionName, std::string oldValue, std::string newValue)
{
...
void
BitTorrentClient::StrategyOptionsChangedEvent()
{
...
void
BitTorrentClient::GatherMetricsEvent()
{
...
void
BitTorrentClient::AnnounceMetrics(std::multimap<std::string, std::string> metrics)
{
    if (!metrics.empty())
    {
        for (std::multimap<std::string, std::string>::const_iterator it = metrics.begin(); it != metrics.end(); ++it)
        {
            std::cout << Simulator::Now().GetMilliSeconds() << ": Node " << GetNode()->GetId() << ": " << (*it).first << "=" << (*it).second
                      << std::endl;
            // GlobalMetricsGatherer::GetInstance ()->WriteToFile ((*it).first, "Node " + lexical_cast<std::string> (GetNode ()->GetId ()) + ": " +
            // (*it).second, true);
        }
    }
}
...
void
BitTorrentClient::RegisterCallbackChokeChangingEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    m_chokeEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackChokeChangingEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>>>::iterator iter = m_chokeEventListeners.begin();
    for (; iter != m_chokeEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackInterestedChangingEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    m_interedEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackInterestedChangingEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>>>::iterator iter = m_interedEventListeners.begin();
    for (; iter != m_interedEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackPeerHaveEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    m_haveEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackPeerHaveEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint32_t>>::iterator iter = m_haveEventListeners.begin();
    for (; iter != m_haveEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackBitfieldReceivedEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    m_bitfieldEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackBitfieldReceivedEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>>>::iterator iter = m_bitfieldEventListeners.begin();
    for (; iter != m_bitfieldEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackRequestEvent(Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t> eventCallback)
{
    m_requestEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackRequestEvent(Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t>>::iterator iter = m_requestEventListeners.begin();
    for (; iter != m_requestEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackCancelEvent(Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t> eventCallback)
{
    m_cancelEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackCancelEvent(Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t>>::iterator iter = m_cancelEventListeners.begin();
    for (; iter != m_cancelEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackPortMessageEvent(Callback<void, Ptr<Peer>, uint16_t> eventCallback)
{
    m_portMessageEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackPortMessageEvent(Callback<void, Ptr<Peer>, uint16_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint16_t>>::iterator iter = m_portMessageEventListeners.begin();
    for (; iter != m_portMessageEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackExtensionMessageEvent(uint8_t messageId, Callback<void, Ptr<Peer>, const std::string&> eventCallback)
{
    m_extensionMessageListeners[messageId].push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackExtensionMessageEvent(uint8_t messageId, Callback<void, Ptr<Peer>, const std::string&> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, const std::string&>>::iterator iter = m_extensionMessageListeners[messageId].begin();
    for (; iter != m_extensionMessageListeners[messageId].end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackConnectionEstablishedEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    m_establishedEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackConnectionEstablishedEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>>>::iterator iter = m_establishedEventListeners.begin();
    for (; iter != m_establishedEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackConnectionFailEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    m_failEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackConnectionFailEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>>>::iterator iter = m_failEventListeners.begin();
    for (; iter != m_failEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackConnectionCloseEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    m_closeEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackConnectionCloseEvent(Callback<void, Ptr<Peer>> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>>>::iterator iter = m_closeEventListeners.begin();
    for (; iter != m_closeEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackCloudConnectionEstablishedEvent(Callback<void, Ptr<BitTorrentClient>> eventCallback)
{
    m_cloudConnectionEstablishedEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackCloudConnectionEstablishedEvent(Callback<void, Ptr<BitTorrentClient>> eventCallback)
{
    std::list<Callback<void, Ptr<BitTorrentClient>>>::iterator iter = m_cloudConnectionEstablishedEventListeners.begin();
    for (; iter != m_cloudConnectionEstablishedEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackCloudConnectionSuspendedEvent(Callback<void, Ptr<BitTorrentClient>> eventCallback)
{
    m_cloudConnectionSuspendedEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackCloudConnectionSuspendedEvent(Callback<void, Ptr<BitTorrentClient>> eventCallback)
{
    std::list<Callback<void, Ptr<BitTorrentClient>>>::iterator iter = m_cloudConnectionSuspendedEventListeners.begin();
    for (; iter != m_cloudConnectionSuspendedEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackPieceRequestedEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    m_pieceRequestedEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackPieceRequestedEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint32_t>>::iterator iter = m_pieceRequestedEventListeners.begin();
    for (; iter != m_pieceRequestedEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackBlockCompleteEvent(Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t> eventCallback)
{
    m_blockCompleteEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackBlockCompleteEvent(Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t>>::iterator iter = m_blockCompleteEventListeners.begin();
    for (; iter != m_blockCompleteEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackPieceCancelledEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    m_pieceCancelledEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackPieceCancelledEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint32_t>>::iterator iter = m_pieceCancelledEventListeners.begin();
    for (; iter != m_pieceCancelledEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackPieceCompleteEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    m_pieceCompleteEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackPieceCompleteEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint32_t>>::iterator iter = m_pieceCompleteEventListeners.begin();
    for (; iter != m_pieceCompleteEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackDownloadCompleteEvent(Callback<void> eventCallback)
{
    m_downloadCompleteEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackDownloadCompleteEvent(Callback<void> eventCallback)
{
    std::list<Callback<void>>::iterator iter = m_downloadCompleteEventListeners.begin();
    for (; iter != m_downloadCompleteEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackPieceTimeoutEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    m_pieceTimeoutEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackPieceTimeoutEvent(Callback<void, Ptr<Peer>, uint32_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint32_t>>::iterator iter = m_pieceTimeoutEventListeners.begin();
    for (; iter != m_pieceTimeoutEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackBlockUploadCompleteEvent(Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t> eventCallback)
{
    m_blockUploadCompleteEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackBlockUploadCompleteEvent(Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t> eventCallback)
{
    std::list<Callback<void, Ptr<Peer>, uint32_t, uint32_t, uint32_t>>::iterator iter = m_blockUploadCompleteEventListeners.begin();
    for (; iter != m_blockUploadCompleteEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackTrackerResponseReceivedEvent(Callback<void> eventCallback)
{
    m_trackerResponseReceivedListerners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackTrackerResponseReceivedEvent(Callback<void> eventCallback)
{
    std::list<Callback<void>>::iterator iter = m_trackerResponseReceivedListerners.begin();
    for (; iter != m_trackerResponseReceivedListerners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackApplicationInitializedEvent(Callback<void, Ptr<BitTorrentClient>> eventCallback)
{
    m_applicationInitializedEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackApplicationInitializedEvent(Callback<void, Ptr<BitTorrentClient>> eventCallback)
{
    std::list<Callback<void, Ptr<BitTorrentClient>>>::iterator iter = m_applicationInitializedEventListeners.begin();
    for (; iter != m_applicationInitializedEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackStrategyOptionsChangedEvent(Callback<void> eventCallback)
{
    m_strategyOptionsChangedEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackStrategyOptionsChangedEvent(Callback<void> eventCallback)
{
    std::list<Callback<void>>::iterator iter = m_strategyOptionsChangedEventListeners.begin();
    for (; iter != m_strategyOptionsChangedEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::RegisterCallbackGatherMetricsEvent(Callback<std::map<std::string, std::string>> eventCallback)
{
    m_gatherMetricsEventListeners.push_back(eventCallback);
}

void
BitTorrentClient::UnregisterCallbackGatherMetricsEvent(Callback<std::map<std::string, std::string>> eventCallback)
{
    std::list<Callback<std::map<std::string, std::string>>>::iterator iter = m_gatherMetricsEventListeners.begin();
    for (; iter != m_gatherMetricsEventListeners.end(); ++iter)
    {
...
void
BitTorrentClient::DisconnectFromCloud()
{
    m_disconnectFromCloud();
}

void
BitTorrentClient::TriggerCallbackAnnounceAsSeeder()
{
    m_announceAsSeeder();
}

void
BitTorrentClient::TriggerCallbackConnectToPeers(uint16_t count)
{
    m_connectToPeers(count);
}

void
BitTorrentClient::TriggerCallbackConnectToPeer(Ipv4Address address, uint16_t port)
{
    m_connectToPeer(address, port);
}

void
BitTorrentClient::TriggerCallbackDisconnectPeers(int32_t count)
{
    m_disconnectPeers(count);
}

void
BitTorrentClient::TriggerCallbackDisconnectPeer(Ptr<Peer> peer)
{
...
void
BitTorrentClient::SetCallbackConnectToCloud(Callback<void> eventCallback)
{
    m_connectToCloud = eventCallback;
}

void
BitTorrentClient::SetCallbackDisconnectFromCloud(Callback<void> eventCallback)
{
    m_disconnectFromCloud = eventCallback;
}

void
BitTorrentClient::SetCallbackAnnounceAsSeeder(Callback<void> eventCallback)
{
    m_announceAsSeeder = eventCallback;
}

void
BitTorrentClient::SetCallbackConnectToPeers(Callback<uint16_t, uint16_t> eventCallback)
{
    m_connectToPeers = eventCallback;
}

void
BitTorrentClient::SetCallbackConnectToPeer(Callback<void, Ipv4Address, uint16_t> eventCallback)
{
    m_connectToPeer = eventCallback;
}

void
BitTorrentClient::SetCallbackDisconnectPeers(Callback<void, int32_t> eventCallback)
{
    m_disconnectPeers = eventCallback;
}

void
BitTorrentClient::SetCallbackDisconnectPeer(Callback<void, Ptr<Peer>> eventCallback)
{
    m_disconnectPeer = eventCallback;
}

void
BitTorrentClient::SetCallbackGetPeerCount(Callback<uint16_t> eventCallback)
{
