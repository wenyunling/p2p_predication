...
void
BitTorrentHandshakeMessage::Serialize(Buffer::Iterator start) const
{
...
uint32_t
BitTorrentHandshakeMessage::Deserialize(Buffer::Iterator start)
{
...
TypeId
BitTorrentHandshakeMessage::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentHandshakeMessage").SetParent<Header>().AddConstructor<BitTorrentHandshakeMessage>();
...
uint32_t
BitTorrentLengthHeader::Deserialize(Buffer::Iterator start)
{
...
void
BitTorrentLengthHeader::Serialize(Buffer::Iterator start) const
{
    start.WriteHtonU32(m_len);
}

TypeId
BitTorrentLengthHeader::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentLengthHeader").SetParent<Header>().AddConstructor<BitTorrentLengthHeader>();
...
uint32_t
BitTorrentTypeHeader::Deserialize(Buffer::Iterator start)
{
...
void
BitTorrentTypeHeader::Serialize(Buffer::Iterator start) const
{
    start.WriteU8(static_cast<uint8_t>(m_type));
}

TypeId
BitTorrentTypeHeader::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentTypeHeader").SetParent<Header>().AddConstructor<BitTorrentTypeHeader>();
...
void
BitTorrentHaveMessage::Serialize(Buffer::Iterator start) const
{
    start.WriteHtonU32(m_pieceIndex);
}

uint32_t
BitTorrentHaveMessage::Deserialize(Buffer::Iterator start)
{
...
TypeId
BitTorrentHaveMessage::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentHaveMessage").SetParent<Header>().AddConstructor<BitTorrentHaveMessage>();
...
void
BitTorrentBitfieldMessage::SetBitFieldSize(uint32_t bitFieldSize)
{
    delete[] m_bitField;
    m_bitField = new uint8_t[bitFieldSize];
    m_bitFieldSize = bitFieldSize;
...
void
BitTorrentBitfieldMessage::CopyBitFieldFrom(const std::vector<uint8_t>* sourceField)
{
...
void
BitTorrentBitfieldMessage::CopyBitFieldTo(std::vector<uint8_t>* targetField) const
{
    for (uint8_t i = 0; i < m_bitFieldSize; ++i)
    {
...
void
BitTorrentBitfieldMessage::Serialize(Buffer::Iterator start) const
{
    start.Write(m_bitField, m_bitFieldSize);
}

uint32_t
BitTorrentBitfieldMessage::Deserialize(Buffer::Iterator start)
{
...
TypeId
BitTorrentBitfieldMessage::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentBitfieldMessage").SetParent<Header>().AddConstructor<BitTorrentBitfieldMessage>();
...
void
BitTorrentRequestMessage::Serialize(Buffer::Iterator start) const
{
    start.WriteHtonU32(m_pieceIndex);
...
uint32_t
BitTorrentRequestMessage::Deserialize(Buffer::Iterator start)
{
    m_pieceIndex = start.ReadNtohU32();
...
TypeId
BitTorrentRequestMessage::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentRequestMessage").SetParent<Header>().AddConstructor<BitTorrentRequestMessage>();
...
void
BitTorrentCancelMessage::Serialize(Buffer::Iterator start) const
{
    start.WriteHtonU32(m_pieceIndex);
    start.WriteHtonU32(m_blockOffset);
    start.WriteHtonU32(m_blockLength);
...
uint32_t
BitTorrentCancelMessage::Deserialize(Buffer::Iterator start)
{
    m_pieceIndex = start.ReadNtohU32();
    m_blockOffset = start.ReadNtohU32();
    m_blockLength = start.ReadNtohU32();
...
TypeId
BitTorrentCancelMessage::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentCancelMessage").SetParent<Header>().AddConstructor<BitTorrentCancelMessage>();
...
void
BitTorrentPieceMessage::Serialize(Buffer::Iterator start) const
{
...
uint32_t
BitTorrentPieceMessage::Deserialize(Buffer::Iterator start)
{
    m_index = start.ReadNtohU32();
    m_begin = start.ReadNtohU32();
    return 8; // Note: This of course does not include the size of the payload, which is to be read separately from the stream after reading this
              // message HEADER
}

TypeId
BitTorrentPieceMessage::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentPieceMessage").SetParent<Header>().AddConstructor<BitTorrentPieceMessage>();
...
void
BitTorrentPortMessage::Serialize(Buffer::Iterator start) const
{
    start.WriteHtonU32(m_listenPort);
}

uint32_t
BitTorrentPortMessage::Deserialize(Buffer::Iterator start)
{
...
TypeId
BitTorrentPortMessage::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentPortMessage").SetParent<Header>().AddConstructor<BitTorrentPortMessage>();
...
void
BitTorrentExtensionMessage::SetContent(const std::string& content)
{
    m_packetLength = content.size() + 1; // + 1 for the messageId
    delete[] m_content;
    m_content = new uint8_t[content.size()];
...
void
BitTorrentExtensionMessage::Serialize(Buffer::Iterator start) const
{
...
uint32_t
BitTorrentExtensionMessage::Deserialize(Buffer::Iterator start)
{
...
TypeId
BitTorrentExtensionMessage::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentExtensionMessage").SetParent<Header>().AddConstructor<BitTorrentExtensionMessage>();

    return tid;
}

std::string
BitTorrentExtensionMessage::GetContent() const
{
    std::string result;
...
NS_OBJECT_ENSURE_REGISTERED(BitTorrentSubscriptionMessage);

BitTorrentSubscriptionMessage::BitTorrentSubscriptionMessage()
{
}

BitTorrentSubscriptionMessage::BitTorrentSubscriptionMessage(const char* streamHash)
{
    std::memcpy(m_StreamHash, streamHash, sizeof(char) * 41);
}
...
void
BitTorrentSubscriptionMessage::Serialize(Buffer::Iterator start) const
{
    start.Write((const uint8_t*)m_StreamHash, sizeof(char) * 41);
}

uint32_t
BitTorrentSubscriptionMessage::Deserialize(Buffer::Iterator start)
{
    start.Read((uint8_t*)m_StreamHash, sizeof(char) * 41);
    return 41;
}

TypeId
BitTorrentSubscriptionMessage::GetTypeId()
{
    static TypeId tid = TypeId("ns3::bittorrent::BitTorrentSubscriptionMessage").SetParent<Header>().AddConstructor<BitTorrentSubscriptionMessage>();
